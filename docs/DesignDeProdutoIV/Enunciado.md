...
hero_subtitle: Brinquedos de Madeira em Desperdício Zero - Trabalho Individual
hero_height: 60vh
hero_overlay: 0.5
hero_align: center
---
...
![](attachments/prancha%20resumo.jpg)
...
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Desenvolvimento** | • Capacidades motoras desenvolvidas<br>• Níveis de compreensão e abstração<br>• Faixa etária alvo<br>• Evolução da interação ao longo do tempo                       |
| **Segurança**       | • Dimensionamento de peças<br>• Resistência dos materiais<br>• Acabamentos e toxicidade<br>• Prevenção de falhas e ruturas                                           |
| **Utilização**      | • Individual vs. coletivo<br>• Nível de supervisão necessário<br>• Ambiente de uso (interior/exterior)<br>• Mobilidade<br>• Impacto sonoro<br>• Manutenção e limpeza |
| **Ciclo de Vida**   | • Durabilidade vs. interesse<br>• Reparação<br>• Gestão de fim de vida<br>• Impacto ambiental<br>• Reciclagem                                                        |
